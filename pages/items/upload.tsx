      ...
      <div className='my-5'>
        ...
        <div className='rounded-md relative flex items-center shadow-sm'>
          ...
          <input
            ...
            type='text'
            placeholder='0.00'
            className='appearance-none pl-7 w-full px-3 py-2 border border-gray-300 rounded-md shadow-md placeholder-gray-400 focus:outline-none focus:ring-orange-400 focus:border-orange-500'
          />
