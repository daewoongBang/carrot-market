    ...
    <div className='px-4 py-16 space-y-8'>
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className='flex flex-col items-start'>
          ...
          <div className='flex space-x-5 text-gray-700 py-2.5 border-t border-b-[2px] w-full'>
      ...
      <button className='fixed bottom-24 right-5 shadow-xl bg-orange-400 hover:bg-orange-500 transition-colors cursor-pointer rounded-full p-4 text-white'>
        <svg
          className='w-6 h-6'
          fill='none'
          stroke='currentColor'
